...
# Users & Passwords
default["identity"]["db"]["user"] = "keystone"
#default["identity"]["db"]["password"] = "keystone"
default["openstack"]["identity"]["admin_user"] = "admin"
default["openstack"]["identity"]["admin_tenant_name"] = "openstack"
...
# endpoints 
default["openstack"]["endpoints"]["identity-admin"]["host"] = node["network"]["interfaces"]["eth0"]["addresses"].select {|address, data| data["family"] == "inet" }.first.first
...
default["openstack"]["endpoints"]["identity-api"]["host"] = node["network"]["interfaces"]["eth0"]["addresses"].select {|address, data| data["family"] == "inet" }.first.first
...
default["openstack"]["endpoints"]["identity-public"]["host"] = "xxx.xxx.xxx.xxx"
default["openstack"]["endpoints"]["identity-public"]["port"] = "5000"
default["openstack"]["endpoints"]["identity-public"]["scheme"] = "http"
default["openstack"]["endpoints"]["identity-public"]["path"] = "/v2.0"

# Other stuff
default["openstack"]["identity"]["bind_interface"] = "eth0"
