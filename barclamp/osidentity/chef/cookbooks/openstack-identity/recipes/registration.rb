...
# added definition for public API endpoint - JPA
...
# Read from attributes rather than encrypted databag
#admin_pass = user_password node["openstack"]["identity"]["admin_user"]
admin_pass = node["openstack"]["identity"]["admin_user_password"]
auth_uri = ::URI.decode identity_admin_endpoint.to_s

# Read from attributes rather than encrypted databag
#bootstrap_token = secret "secrets", "openstack_identity_bootstrap_token"
bootstrap_token = node["openstack"]["identity"]["openstack_identity_bootstrap_token"]
